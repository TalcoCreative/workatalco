  ...
  useEffect(() => {
    if (kol) {
      setFormData({
        ...
        link_account: kol.link_account || "",
        instagram_url: kol.instagram_url || "",
        tiktok_url: kol.tiktok_url || "",
        twitter_url: kol.twitter_url || "",
        linkedin_url: kol.linkedin_url || "",
        youtube_url: kol.youtube_url || "",
        threads_url: kol.threads_url || "",
        ig_followers: kol.ig_followers?.toString() || "",
        tiktok_followers: kol.tiktok_followers?.toString() || "",
        twitter_followers: kol.twitter_followers?.toString() || "",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh]">
        <DialogHeader>
          <DialogTitle>Edit KOL: {kol?.name}</DialogTitle>
        </DialogHeader>
